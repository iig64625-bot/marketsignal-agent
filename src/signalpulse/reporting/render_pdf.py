...
Install with: ``pip install signalpulse-agent[pdf]``
"""
...
def markdown_to_pdf(
    ...
    out_path: str | Path,
    *,
    title: str = "SignalPulse Report",
    author: str = "SignalPulse Agent",
) -> Path:
    ...
    try:
        ...
        raise ImportError(
            "PDF rendering requires fpdf2. Install with `pip install signalpulse-agent[pdf]`"
        ) from exc
