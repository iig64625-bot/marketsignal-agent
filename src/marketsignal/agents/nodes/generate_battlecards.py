...
from marketsignal.reporting.battlecard_extras import generate_battlecard_extras
from marketsignal.reporting.render_markdown import render_battlecard
...
async def generate_battlecards_node(state: GraphState) -> GraphState:
    ...
    with get_session() as s:
        ...
        out_dir = Path(os.environ.get("MARKETSIGNAL_REPORT_DIR", "data/reports"))
