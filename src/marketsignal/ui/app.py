"""MarketSignal Agent - Streamlit demo UI.
...
from marketsignal.ui.components.report_viewer import render_report_viewer, render_signal_timeline
from marketsignal.ui.components.run_monitor import render_run_monitor
from marketsignal.ui.components.sidebar import render_sidebar

st.set_page_config(
    page_title="MarketSignal Agent",
    layout="wide",
